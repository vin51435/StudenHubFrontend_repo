...
const Login: React.FC = () => {
  return (
    <div className="auth-page_main relative">
      <Row className="h-full">
        ...
        <Col xs={24} md={10} lg={8} className="left_container px-6 py-4 !justify-center">
        ...
        <Col xs={24} md={14} lg={16} className="right_container hidden md:block">
          <div className="auth-page_main_img">image</div>
        </Col>
      </Row>
    </div>
  );
